...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.idle_frames = load_frames(["饮料瓶.png"], GREEN, (30, 30), "circle")
...
def main():
    ...
    while running:
        ...
        if game_state == "MENU":
            ...
            screen.fill((20,20,30))
            for i, line in enumerate(["【绝境突围：无尽肉鸽】", "操作：WASD移动，左键射击，TAB商店，1/2切武器，F键拾取，空格键技能。", "机制：击败敌人掉落金币，用于强化；打碎白色箱子可获取新武器。", "      由于装备栏有限，拾取新武器会丢下旧武器。", "      每过3关可选择强力天赋。每过5关将遭遇强大BOSS！"]):
