...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y, angle, damage, player, is_skill=False):
        ...
        # 👇 🖼️👉 【替换贴图：玩家射出的子弹】(如果有需要的话，目前是一颗白/紫球)
...
def draw_hud(screen, player, skill_icon_img):
    ...
    # ---------------- 技能图标 UI ----------------
    # 统一尺寸和坐标
    icon_size = 40  # 对应我们上方 load_frames 设置的 40x40 尺寸
    icon_x, icon_y = 30, SCREEN_HEIGHT - 80  # 移动到屏幕左下角偏下区域
    ...
    # 绘制配套的提示文字 (字体大小调成 font_base 并且和图标垂直居中)
...
def main():
    ...
    # 👇 🖼️👉 【替换贴图：技能图标 (左下角展示用)，请保证它是一个 40x40 大小的图】
